...
export type Type = ProtoFile | Service | Method | Message | Field | Oneof | Enum | EnumValue | Extension;
...
export enum ProtoFolderType {MainProtoFolder, IncludeProtoFolder}
...
export type FieldType = PrimitiveFieldType | WrapperFieldType | EnumFieldType | MessageFieldType | RepeatedFieldType | MapFieldType;
export type ElementTypes = PrimitiveFieldType | WrapperFieldType | EnumFieldType | MessageFieldType;

export enum FieldKind {Primitive = 'Primitive', Wrapper = 'Wrapper', Enum = 'Enum', Message = 'Message', Repeated = 'Repeated', Map = 'Map'}
...
export type WrapperTypes = Primitives.DOUBLE | Primitives.FLOAT | Primitives.INT32 | Primitives.INT64 | Primitives.UINT64 | Primitives.UINT32 |
  Primitives.BOOL | Primitives.STRING | Primitives.BYTES;


export type MapKeyTypes = Primitives.INT32 | Primitives.INT64 | Primitives.UINT64 | Primitives.UINT32 | Primitives.BOOL |
  Primitives.STRING | Primitives.SFIXED32 | Primitives.SFIXED64 | Primitives.SINT32 | Primitives.SINT64;
...
export type SourceCodeContainer = Type | Option;
...
export enum OptionType {FileOptions = 1, ServiceOptions, MethodOptions, MessageOptions, EnumOptions, EnumValueOptions, FieldOptions, OneofOptions}
...
export type BaseTypedOption<OT extends OptionType, _T> = {
  extensionNumber: number;
  optionType: OT;
};

export type TypedOption<OT extends OptionType, T> = BaseTypedOption<OT, T> & {repeated: false};
export type RepeatedTypedOption<OT extends OptionType, T> = BaseTypedOption<OT, T> & {repeated: true};
