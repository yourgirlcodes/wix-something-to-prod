...
exports.rule = {
    description: 'validates CRUD REMOVE_FROM_TRASHBIN method annotation',
    severity: flynt_engine_1.Severity.Error,
    run(ctx) {
        ctx.visit({
            visitMethod(method) {
                const crudOption = method.options.getTypedOption(wix_1.wix.api.crud);
                if (crudOption && crudOption.value.method === annotations_1.Crud.Method.REMOVE_FROM_TRASHBIN) {
                    (0, crud_utils_1.validateIdField)(crudOption.value.removeFromTrashbinOptions, method, ctx);
                }
            }
        });
    }
