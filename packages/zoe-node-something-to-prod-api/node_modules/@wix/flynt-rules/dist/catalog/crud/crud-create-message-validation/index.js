...
exports.rule = {
    description: 'validates CRUD CREATE method annotation',
    severity: flynt_engine_1.Severity.Error,
    run(ctx) {
        ctx.visit({
            visitMethod(method) {
                const crudOption = method.options.getTypedOption(wix_1.wix.api.crud);
                if (crudOption && crudOption.value.method === annotations_1.Crud.Method.CREATE) {
                    (0, crud_utils_1.validateItemField)(crudOption.value.createOptions, method, method.request, ctx);
                    (0, crud_utils_1.validateFieldMask)(crudOption.value.createOptions, method, ctx);
                }
            }
        });
    }
