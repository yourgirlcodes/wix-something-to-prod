...
exports.rule = {
    description: 'validates CRUD GET_ITEM method annotation',
    severity: flynt_engine_1.Severity.Error,
    run(ctx) {
        ctx.visit({
            visitMethod(method) {
                const crudOption = method.options.getTypedOption(wix_1.wix.api.crud);
                if (crudOption && crudOption.value.method === annotations_1.Crud.Method.GET_ITEM) {
                    (0, crud_utils_1.validateItemField)(crudOption.value.getOptions, method, method.response, ctx);
                    (0, crud_utils_1.validateIdField)(crudOption.value.getOptions, method, ctx);
                }
            }
        });
    }
