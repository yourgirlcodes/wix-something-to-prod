...
exports.rule = {
    description: 'validates CRUD DELETE method annotation',
    severity: flynt_engine_1.Severity.Error,
    run(ctx) {
        ctx.visit({
            visitMethod(method) {
                const crudOption = method.options.getTypedOption(wix_1.wix.api.crud);
                if (crudOption && crudOption.value.method === annotations_1.Crud.Method.DELETE) {
                    (0, crud_utils_1.validateIdField)(crudOption.value.deleteOptions, method, ctx);
                }
            }
        });
    }
