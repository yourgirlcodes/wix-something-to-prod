...
exports.rule = {
    description: 'SPI Error data must be a valid message',
    moreInfoUrl: 'https://bo.wix.com/wix-docs/rnd/platformization-guidelines/spi---service-provider-interface#platformization-guidelines_spi---service-provider-interface_proto',
                ...
                for (const error of errors) {
                    ...
                    if (dataMessageFqn) {
                        ctx.assertTypeExists(dataMessageFqn, flynt_engine_1.TypeName.Message, {
                            errorAt: error,
                            message: 'wix.spi.error data should be a valid message'
                        });
                    }
                }
            }
