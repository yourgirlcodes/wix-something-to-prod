    ...
    export namespace wix {
        export namespace api {
            ...
            export interface ResponseContext {
                aspects?: $requests.wix.api.ResponseContextEntry[];
            }
            ...
            export interface Subscription {
                ...
                batch?: boolean;
                entity?: string;
                consumeMode?: $requests.wix.api.MessageConsumeMode;
            }
            export enum MessageConsumeMode {
                SINGLE_MESSAGE = 0,
                BATCH_MESSAGES = 1,
        ...
        export namespace http {
            export interface InferFieldmask {
                from?: string;
                fieldmask?: string;
            }
        }
    ...
    export namespace google {
        export namespace protobuf {
            ...
            export interface MessageOptions {
                ...
                mapEntry?: boolean;
                uninterpretedOption?: $requests.google.protobuf.UninterpretedOption[];
                '.wix.api.actionPayload'?: $requests.wix.api.ActionPayload;
            ...
            export interface ServiceOptions {
                ...
                '.wix.spi.service'?: $requests.wix.spi.Service;
                '.wix.spi.event'?: $requests.wix.spi.Event[];
            }
            export interface MethodOptions {
                ...
                '.wix.api.sla'?: $requests.wix.api.Sla;
                '.wix.api.subscription'?: $requests.wix.api.Subscription;
                '.wix.api.required'?: string[];
                '.wix.api.writable'?: string[];
                '.wix.http.inferFieldmask'?: $requests.wix.http.InferFieldmask;
                '.wix.sdk.signature'?: $requests.wix.sdk.Signature[];
                '.wix.spi.error'?: $requests.wix.spi.Error[];
...
declare namespace $responses {
    export namespace wix {
        export namespace api {
            ...
            export interface ResponseContext {
                aspects: $responses.wix.api.ResponseContextEntry[];
            }
            export interface ResponseContextEntry {
                aspectEntry?: { [k: string]: string };
            }
            ...
            export interface Subscription {
                ...
                batch: boolean;
                entity: string;
                consumeMode: $responses.wix.api.MessageConsumeMode;
            }
            export enum MessageConsumeMode {
                SINGLE_MESSAGE = 0,
                BATCH_MESSAGES = 1,
    ...
    export namespace google {
        export namespace protobuf {
            ...
            export interface MessageOptions {
                ...
                mapEntry: boolean;
                uninterpretedOption: $responses.google.protobuf.UninterpretedOption[];
                '.wix.api.actionPayload'?: $responses.wix.api.ActionPayload;
                '.wix.api.decompositeOf': string;
            ...
            export interface ServiceOptions {
                ...
                '.wix.spi.service'?: $responses.wix.spi.Service;
                '.wix.spi.event': $responses.wix.spi.Event[];
            }
            export interface MethodOptions {
                deprecated: boolean;
                ...
                '.wix.api.sla'?: $responses.wix.api.Sla;
                '.wix.api.subscription'?: $responses.wix.api.Subscription;
                '.wix.api.required': string[];
                '.wix.api.writable': string[];
                '.wix.http.inferFieldmask'?: $responses.wix.http.InferFieldmask;
                '.wix.sdk.signature': $responses.wix.sdk.Signature[];
                '.wix.spi.error': $responses.wix.spi.Error[];
                '.wix.spi.featureToggle': string;
            }
            export namespace MethodOptions {
                export enum IdempotencyLevel {
